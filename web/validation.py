...
# Canonical impl lives in shared/ so the worker image (which never COPYs web/) can import
# it for the delivery-time SSRF re-check. Re-exported here for existing callers.
from webhook_validation import validate_webhook_url  # noqa: F401
