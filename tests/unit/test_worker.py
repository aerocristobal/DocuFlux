...
class TestUpdateMetricsCachesWorkerStatus:
    ...
    @patch('tasks.celery')
    @patch('tasks.redis_client')
    @patch('tasks.update_queue_metrics')
    @patch('tasks.update_redis_pool_metrics')
...
class TestRedisPoolMetrics:
    ...
    @patch('tasks.update_queue_metrics')
    @patch('tasks.update_redis_pool_metrics')
    def test_update_metrics_calls_pool_updater(self, mock_pool_fn, mock_queue, mock_redis, mock_celery):
        ...
        mock_pool_fn.assert_called_once_with(mock_redis)
